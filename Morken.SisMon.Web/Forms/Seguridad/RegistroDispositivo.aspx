<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroDispositivo.aspx.cs" Inherits="Forms_Seguridad_RegistroDispositivo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Seguridad/RegistroDispositivo.js" />
        </Scripts>
    </cc:ScriptCombine>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
            ...
            <div class="box box box-warning">
                <div class="box-body">
                    <div class="form-group">
                        <label for="txtCodigo">Ip:</label>
                        <asp:TextBox ID="txtIp" runat="server" ClientIDMode="Static" MaxLength="20" CssClass="form-control" placeholder="Ingrese la ip" />
                    </div>
                    <div class="form-group">
                        <label for="txtNombre">Host Name:</label>
                        <asp:TextBox ID="txtNombre" runat="server" ClientIDMode="Static" MaxLength="50" CssClass="form-control" placeholder="Ingrese el host name" />
                    </div>
                    <div class="form-group">
    ...
    <asp:HiddenField ID="hdIdDispositivo" runat="server" ClientIDMode="Static" />
</asp:Content>
